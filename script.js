...
// let allOrders = ["Laptop","Keyboard","Mouse","Computer"];
...
// //console.log(upper(allOrders[i]))
// //}

// // const new_arr =allOrders.map((i)=>
// //     i.toLowerCase()
// // )


// console.log("new_array=",new_arr);

//wap tp print square using map()
...
// //let allOrders = ["Laptop","Mouse","Keyboard","Headphones"];
// //wap to print length
// let allOrders = ["Laptop", "Mouse", "Keyboard", "Headphones"];

// // console.log(allOrders.length);

// const new_arr = allOrders.filter(  (i)=> 
//     i.length >5
// )
